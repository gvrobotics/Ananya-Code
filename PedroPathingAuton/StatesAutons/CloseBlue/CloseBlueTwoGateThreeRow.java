...
@Autonomous(group = "Close Blue", name = "1. Close Blue 2 Gate 3 Row", preselectTeleOp = "Tele 5440")
public class CloseBlueTwoGateThreeRow extends OpMode {
    ...
    private final Pose move = new Pose(95.7, 73.1, Math.toRadians(0)).mirror();
    private final Pose gate = new Pose(129.4, 67.4, Math.toRadians(0)).mirror();
    private final Pose gateOut = new Pose(114.6, 67.4, Math.toRadians(0)).mirror();
