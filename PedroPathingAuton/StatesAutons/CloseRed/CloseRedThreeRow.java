...
@Autonomous(group = "Close Red", name = "5. Close Red 3 Rows", preselectTeleOp = "Tele 5440")
public class CloseRedThreeRow extends OpMode {
    ...
    private final Pose endPose = new Pose(89.6, 71.3, Math.toRadians(0));
    // Paths
