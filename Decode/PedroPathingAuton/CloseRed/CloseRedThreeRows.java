...
@Autonomous(group = "Close Red", name = "1. Close Red Three Rows", preselectTeleOp = "Tele 5440")
public class CloseRedThreeRows extends OpMode {
    ...
    private final Pose thirdRowStart = new Pose(rowStart, 36, Math.toRadians(0));
    private final Pose thirdRowEnd = new Pose(rowEnd, 36, Math.toRadians(0));
