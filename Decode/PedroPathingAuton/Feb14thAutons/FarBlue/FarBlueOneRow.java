...
//@Autonomous(group = "Far Blue", name = "2. Far Blue One Row", preselectTeleOp = "Tele 5440")
public class FarBlueOneRow extends OpMode {
    ...
    private final Pose thirdRowStart = new Pose(rowStart, 35.3, Math.toRadians(0)).mirror();
    private final Pose thirdRowEnd = new Pose(rowEnd, 35.3, Math.toRadians(0)).mirror();
