package org.firstinspires.ftc.teamcode.PedroPathingAuton.Feb14thAutons.CloseBlue;
...
//@Autonomous(group = "Close Blue", name = "1. Close Blue Three Rows", preselectTeleOp = "Tele 5440")
public class CloseBlueThreeRows extends OpMode {
    ...
    private final Pose thirdRowStart = new Pose(rowStart, 36, Math.toRadians(0)).mirror();
    private final Pose thirdRowEnd = new Pose(rowEnd, 36, Math.toRadians(0)).mirror();
    ...
    public void buildPaths() {
        ...
        driveThirdRowToShootPose = follower.pathBuilder()
                .addPath(new BezierLine(thirdRowEnd, endPose))
    ...
    private void setupShot() {
        ...
        // Always set fallback parameters in acase Limelight fails
