...
//@Autonomous(group = "Close Blue", name = "3. Close Blue Two Rows Gate", preselectTeleOp = "Tele 5440")
public class CloseBlueOpenGate extends OpMode {
    ...
    PathState pathState;
    private double rowStart = 98, rowEnd = 132.5;
    ...
    private final Pose secondRowStart = new Pose(rowStart, 60.5, Math.toRadians(0)).mirror();
    ...
    private final Pose secondRowEnd = new Pose(rowEnd, 60.5, Math.toRadians(0)).mirror();
