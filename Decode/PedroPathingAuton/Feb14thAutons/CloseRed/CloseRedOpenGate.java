package org.firstinspires.ftc.teamcode.PedroPathingAuton.Feb14thAutons.CloseRed;
...
//@Autonomous(group = "Close Red", name = "3. Close Red Two Rows Gate", preselectTeleOp = "Tele 5440")
public class CloseRedOpenGate extends OpMode {
    ...
    private final Pose firstRowStart = new Pose(rowStart, 84, Math.toRadians(0));
    private final Pose firstRowEnd = new Pose(128, 84, Math.toRadians(0));
    private final Pose secondRowStart = new Pose(rowStart, 60.5, Math.toRadians(0));
    ...
    private final Pose secondRowEnd = new Pose(rowEnd, 60.5, Math.toRadians(0));
