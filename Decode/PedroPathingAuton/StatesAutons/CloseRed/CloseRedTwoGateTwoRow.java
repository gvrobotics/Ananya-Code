...
@Autonomous(group = "Close Red", name = "2. Close Red 2 Gate 2 Row", preselectTeleOp = "Tele 5440")
public class CloseRedTwoGateTwoRow extends OpMode {
    ...
    public void statePathUpdate() {
        switch (pathState) {
            ...
            case ALIGN_AND_SHOOT_FIRSTROW:
                if (!follower.isBusy()) {
                    handleShoot(PathState.DRIVE_SHOOT_TO_ENDPOS);
                }
                break;

            case DRIVE_SHOOT_TO_ENDPOS:
