...
@Autonomous(group = "Close Red", name = "4. Close Red 1 Gate 2 Rows", preselectTeleOp = "Tele 5440")
public class CloseRedOneGateTwoRow extends OpMode {
    ...
    private double firstRowPos = 83.6, secondRowPos = 59.5;
    ...
    private final Pose move = new Pose(114.8, 66.2, Math.toRadians(0));
    private final Pose gate = new Pose(129.2, 65.9, Math.toRadians(0));
    private final Pose gateOut = new Pose(89.6, 71.3, Math.toRadians(0));
