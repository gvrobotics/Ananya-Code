...
@Autonomous(group = "Far Red", name = "9. Far Red HP", preselectTeleOp = "Tele 5440")
public class FarRedHP extends OpMode {
    ...
    public enum PathState {
        ...
        //------HP 3------
        DRIVE_SHOOT_TO_HP3,
        DRIVE_HP3_START_TO_END,
        DRIVE_HP3_END_TO_SHOOT,
        ALIGN_AND_SHOOT_HP3,
        DRIVE_SHOOT_ENDPOS,
        COMPLETE
    }
    ...
    public void statePathUpdate() {
        ...
        switch (pathState) {
            ...
            case ALIGN_AND_SHOOTHP2:
                if (!follower.isBusy()) {
                    handleShoot(PathState.DRIVE_SHOOT_TO_HP3);
                }
                break;

            // ==================== HP3 ====================
            case DRIVE_SHOOT_TO_HP3:
                handleDriveToRowStart(driveShootPosHp1Pose, PathState.DRIVE_HP3_START_TO_END);
                break;

            case DRIVE_HP3_START_TO_END:
                handleRowCollection(driveHp1StartToEndPose, PathState.DRIVE_HP3_END_TO_SHOOT);
                break;

            case DRIVE_HP3_END_TO_SHOOT:
                follower.followPath(driveHp1ToShootPose, true);
                setPathState(PathState.ALIGN_AND_SHOOT_HP3);
                break;

            case ALIGN_AND_SHOOT_HP3:
                if (!follower.isBusy()) {
