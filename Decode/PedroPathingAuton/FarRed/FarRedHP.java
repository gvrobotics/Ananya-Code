package org.firstinspires.ftc.teamcode.PedroPathingAuton.FarRed;
...
@Autonomous(group = "Far Red", name = "1. Far Red HP", preselectTeleOp = "Tele 5440")
public class FarRedHP extends OpMode {
    ...
    private final Pose hp1Start = new Pose(108.8, 16.5, Math.toRadians(0));
    private final Pose hp1End = new Pose(136.3, 16.5, Math.toRadians(0));
    private final Pose hp2Start = new Pose(112.1, 7.5, Math.toRadians(0));
    private final Pose hp2End = new Pose(136, 7.5, Math.toRadians(0));
    ...
    private PathChain driveStartPosShootPos, driveShootPosHp1StartPose,
            ...
            driveHp2StartToEndPose, driveHp2ToShootPose, driveShootPosEndPose;
    ...
    public void buildPaths() {
        ...
        driveHp2ToShootPose = follower.pathBuilder()
                .addPath(new BezierLine(hp2End, shootPose))
                .setLinearHeadingInterpolation(hp2End.getHeading(), shootPose.getHeading())
                .build();
    ...
    public void statePathUpdate() {
        ...
        switch (pathState) {
            ...
            case DRIVE_HP1_END_TO_HP2_START:
                handleDriveToRowStart(driveHp1EndToHp2StartPose, PathState.DRIVE_HP2_START_TO_END);
                break;

            // ===== HP2 COLLECTION =====

            case DRIVE_HP2_START_TO_END:
                handleRowCollection(driveHp2StartToEndPose, PathState.DRIVE_HP2_END_TO_SHOOTPOS);
                break;

            case DRIVE_HP2_END_TO_SHOOTPOS:
                follower.followPath(driveHp2ToShootPose, true);
                setPathState(PathState.ALIGN_AND_SHOOT_HP);
                break;
