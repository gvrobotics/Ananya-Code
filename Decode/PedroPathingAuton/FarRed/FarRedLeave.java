...
@Autonomous (group = "Far Red", name = "4. Far Red Leave", preselectTeleOp = "Tele 5440")
public class FarRedLeave extends OpMode {
    ...
    private final Pose startPose = new Pose(93, 9, Math.toRadians(90));
    private final Pose endPose = new Pose(93, 33, Math.toRadians(0));
