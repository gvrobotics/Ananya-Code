...
@Autonomous 
public class CloseBlueShootPreload extends OpMode {
    ...
    private final Pose startPose = new Pose(26.454072790294617, 129.2755632582322, Math.toRadians(135));
    private final Pose shootPose = new Pose(51.36429809358751, 99.3275563258232, Math.toRadians(135));
    private final Pose endPose = new Pose(64.92201039861352, 114.27383015597921, Math.toRadians(180));
