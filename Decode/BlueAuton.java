...
@Autonomous (name = "Blue Auton Nov 8th", group = "Auton")
public class BlueAuton extends LinearOpMode {
    ...
    private void shooter(double power, int numShots) {
        ...
        // Give time for shooter to spin up
        sleep(800);

        // Sequence to shoot each ball
        for (int i = 0; i < numShots; i++) {
            flip.setPosition(0.2);  // Move ball up
            sleep(1000); // Pause
            flip.setPosition(0);    // Move back down for next ball
            sleep(1000);
        }
